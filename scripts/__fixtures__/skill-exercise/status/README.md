...
The fixture contains no credentials, remote repository, automated-runner state, or mutable process. Tests materialize disposable git repositories in the operating-system temporary directory and remove them after each run.
