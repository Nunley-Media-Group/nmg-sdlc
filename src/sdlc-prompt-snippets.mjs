...
const CATALOG = [
  ...
  ["plugin.workflow.open-pr", "workflows/open-pr/WORKFLOW.md", ["sdlc-open-pr", "worker:deliver"], "body", 100, 3644],
  ...
  ["plugin.workflow.address-pr-comments", "workflows/address-pr-comments/WORKFLOW.md", ["worker:deliver"], "extra", 200, 2157],
