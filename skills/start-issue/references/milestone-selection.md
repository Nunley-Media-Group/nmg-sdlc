...
- **Interactive mode**: present the filtered milestone list via `request_user_input` gate (option label: milestone title; description: "N open issues"), then fetch issues from the selected milestone.
