...
Generate this document during `/setup-steering`. Pre-fill what you can discover from the codebase, and leave the rest as templates for the user to customize.
