...
**Read this when** Step 2G.1 of `references/greenfield.md` runs. The interview captures the seven inputs steering bootstrap (2G.2) and starter-issue generation (2G.4) consume.
...
Emit at the end: `Interview: complete (N rounds)`.
