...
When the cached sentinel is absent, prompt via Codex interactive gate:
...
- Never present a Codex interactive gate. Do not offer a fallback prompt and do not block on any input — that would hang the runner.
