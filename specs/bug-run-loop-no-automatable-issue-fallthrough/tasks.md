# Tasks: Run-loop no-automatable issue fallthrough
...
**File(s)**: specs/bug-run-loop-no-automatable-issue-fallthrough/feature.gherkin, existing or new tests listed in design.md
**Type**: Create / Modify
**Depends**: T001
**Acceptance**:
...
| Issue | Date | Summary |
|-------|------|---------|
| #114 | 2026-04-26 | Initial defect tasks |
