...
**File(s)**: `scripts/__tests__/select-next-issue-from-milestone.test.mjs`, `scripts/__tests__/epic-relationship-contract.test.mjs`, `scripts/__tests__/exercise-start-issue-epic.test.mjs`, `specs/bug-fix-epic-membership-deadlocking-issue-selection/feature.gherkin`
**Type**: Create / Modify
**Depends**: T002
**Acceptance**:
