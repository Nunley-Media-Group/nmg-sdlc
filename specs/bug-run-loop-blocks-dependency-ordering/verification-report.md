...
- [x] AC1: Bug Is Fixed -- Implemented in scripts/sdlc-runner.mjs, scripts/__tests__/select-next-issue-from-milestone.test.mjs
...
|----------|----------|----------|-------|-----|---------|
| High | Defect | scripts/sdlc-runner.mjs, scripts/__tests__/select-next-issue-from-milestone.test.mjs | Issue selection interprets Blocks: #N backwards, allowing blocked issues to run before their prerequisites. | Corrected Blocks: edge direction. Updated regression coverage for dependency ordering. Verified through the full scripts test suite. | direct / skill-creator-guided for skill-bundled docs |
