# Tasks: Run-loop Blocks dependency ordering
...
**File(s)**: scripts/sdlc-runner.mjs, scripts/__tests__/select-next-issue-from-milestone.test.mjs
**Type**: Modify
**Depends**: None
**Acceptance**:
...
**File(s)**: specs/bug-run-loop-blocks-dependency-ordering/feature.gherkin, existing or new tests listed in design.md
**Type**: Create / Modify
**Depends**: T001
**Acceptance**:
...
| Issue | Date | Summary |
|-------|------|---------|
| #119 | 2026-04-26 | Initial defect tasks |
