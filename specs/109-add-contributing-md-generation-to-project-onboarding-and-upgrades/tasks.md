...
**File(s)**: `scripts/__tests__/exercise-contribution-guide.test.mjs`, `specs/109-add-contributing-md-generation-to-project-onboarding-and-upgrades/verification-report.md`
**Type**: Create
...
**File(s)**: `specs/109-add-contributing-md-generation-to-project-onboarding-and-upgrades/verification-report.md`
**Type**: Create
