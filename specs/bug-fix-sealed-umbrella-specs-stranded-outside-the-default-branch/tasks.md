...
**File(s)**: `scripts/__tests__/umbrella-spec-status.test.mjs`, `scripts/__tests__/canonical-umbrella-spec-contract.test.mjs`, `scripts/__tests__/exercise-write-spec-epic.test.mjs`, `scripts/__tests__/exercise-upgrade-sealed-spec.test.mjs`, `specs/bug-fix-sealed-umbrella-specs-stranded-outside-the-default-branch/feature.gherkin`
**Type**: Create / Modify
**Depends**: T004
**Acceptance**:
