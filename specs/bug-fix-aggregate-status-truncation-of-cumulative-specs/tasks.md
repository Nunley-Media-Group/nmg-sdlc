...
**File(s)**: `scripts/__tests__/sdlc-status.test.mjs`, `scripts/__tests__/issue-scope-contract.test.mjs`, `specs/bug-fix-aggregate-status-truncation-of-cumulative-specs/feature.gherkin`
**Type**: Modify / Create
**Depends**: T001
**Acceptance**:
