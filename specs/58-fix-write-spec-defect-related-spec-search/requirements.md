...
- Then: It finds `specs/107-add-skill-to-run-full-sdlc-pipeline-loop-from-within-codex/requirements.md` as a match
...
**Example**:
- Given: `specs/107-add-skill-to-run-full-sdlc-pipeline-loop-from-within-codex/` exists and matches the bug's keywords
- When: The search finds this spec
- Then: The **Related Spec** field is set to `specs/107-add-skill-to-run-full-sdlc-pipeline-loop-from-within-codex/`
