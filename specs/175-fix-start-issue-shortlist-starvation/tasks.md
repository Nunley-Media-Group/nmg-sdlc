...
**Files**: `scripts/__tests__/start-issue-selection-contract.test.mjs`, `scripts/__tests__/exercise-start-issue-backfill.test.mjs`, `specs/175-fix-start-issue-shortlist-starvation/feature.gherkin`
