...
**File(s)**: `scripts/__tests__/sdlc-runner.test.mjs`, `specs/124-fix-stale-pluginroot-config-blocking-sdlc-loop/feature.gherkin`
**Type**: Modify
...
**File(s)**: `scripts/__tests__/sdlc-runner.test.mjs`, changed skill-bundled files, `README.md`, `specs/124-fix-stale-pluginroot-config-blocking-sdlc-loop/feature.gherkin`
**Type**: Verify
**Depends**: T004, T005
**Acceptance**:
