# Tasks: Run-loop nested Codex sandbox inheritance
...
**File(s)**: specs/bug-run-loop-nested-codex-sandbox-inheritance/feature.gherkin, existing or new tests listed in design.md
**Type**: Create / Modify
**Depends**: T001
**Acceptance**:
...
| Issue | Date | Summary |
|-------|------|---------|
| #113 | 2026-04-26 | Initial defect tasks |
