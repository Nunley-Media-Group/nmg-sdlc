...
|----------|----------|----------|-------|-----|---------|
| High | Defect | scripts/sdlc-runner.mjs, scripts/__tests__/sdlc-runner.test.mjs | Child codex exec sessions inherit parent sandbox environment variables and can fail before the SDLC step runs. | Implemented environment filtering in scripts/sdlc-runner.mjs. Added regression coverage in scripts/__tests__/sdlc-runner.test.mjs. Verified through the full scripts test suite. | direct / skill-creator-guided for skill-bundled docs |
