...
**File(s)**: `specs/114-fix-stale-spec-references/inventory.txt` (scratch — not committed)
...
- [ ] Confirm the redirect target exists: `specs/107-add-skill-to-run-full-sdlc-pipeline-loop-from-within-codex/requirements.md` is present
