...
|----------|----------|----------|-------|-----|---------|
| High | Defect | scripts/sdlc-runner.mjs, scripts/__tests__/sdlc-runner.test.mjs | Step 1 can mutate the repository before validating a clean worktree and its prompt included destructive cleanup language. | Implemented early Step 1 clean-tree validation. Removed destructive prompt language. Added dirty-tree and prompt regression tests. | direct / skill-creator-guided for skill-bundled docs |
