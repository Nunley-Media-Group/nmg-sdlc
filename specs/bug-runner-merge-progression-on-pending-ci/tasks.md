# Tasks: Runner merge progression on pending CI
...
**File(s)**: specs/bug-runner-merge-progression-on-pending-ci/feature.gherkin, existing or new tests listed in design.md
**Type**: Create / Modify
**Depends**: T001
**Acceptance**:
...
| Issue | Date | Summary |
|-------|------|---------|
| #118 | 2026-04-26 | Initial defect tasks |
