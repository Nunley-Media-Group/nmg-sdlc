...
**File(s)**: `specs/140-add-simplify-step-to-sdlc-pipeline/feature.gherkin`
**Type**: Create
...
- [ ] Header comment links back to `specs/140-add-simplify-step-to-sdlc-pipeline/requirements.md` and issue #140
