# Tasks: Runner spec validation accepts unrelated specs
...
**File(s)**: specs/bug-runner-spec-validation-accepts-unrelated-specs/feature.gherkin, existing or new tests listed in design.md
**Type**: Create / Modify
**Depends**: T001
**Acceptance**:
...
| Issue | Date | Summary |
|-------|------|---------|
| #115 | 2026-04-26 | Initial defect tasks |
