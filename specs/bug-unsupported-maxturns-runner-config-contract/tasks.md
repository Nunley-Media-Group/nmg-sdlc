# Tasks: Unsupported maxTurns runner config contract
...
**File(s)**: scripts/sdlc-config.example.json, README.md, skills/upgrade-project/SKILL.md, skills/upgrade-project/references/upgrade-procedures.md, skills/upgrade-project/references/verification.md, scripts/__tests__/runner-config-contract.test.mjs
**Type**: Modify
**Depends**: None
**Acceptance**:
...
**File(s)**: specs/bug-unsupported-maxturns-runner-config-contract/feature.gherkin, existing or new tests listed in design.md
**Type**: Create / Modify
**Depends**: T001
**Acceptance**:
...
| Issue | Date | Summary |
|-------|------|---------|
| #117 | 2026-04-26 | Initial defect tasks |
