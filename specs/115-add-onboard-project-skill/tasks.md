...
**File(s)**: `specs/115-add-onboard-project-skill/feature.gherkin`
...
**File(s)**: `README.md`, `CHANGELOG.md`, `plugins/nmg-sdlc/.codex-plugin/plugin.json`, `.codex-plugin/marketplace.json`, `specs/115-add-onboard-project-skill/feature.gherkin`
**Type**: Modify
**Depends**: T025
**Acceptance**:
