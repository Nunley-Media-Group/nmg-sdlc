# Design: Project Upgrade Compatibility
...
The public surface is `/sdlc-migrate-project and /sdlc-upgrade-project`. Normative behavior lives in `skills/migrate-project/; skills/upgrade-project/; scripts/sdlc-upgrade.mjs` and follows the OMP extension, native `/plan`, and Herdr OMP worker boundaries defined by steering.
...
The maintained checks are `scripts/__tests__/sdlc-upgrade.test.mjs`. They must exercise the public outcome rather than source-text coincidence.
