...
| `specs/bug-fix-canonical-umbrella-rejection-of-issue-scope-manifests/*` | Record requirements, design, tasks, and regression scenarios for #173. | Preserves issue-to-implementation traceability. |
