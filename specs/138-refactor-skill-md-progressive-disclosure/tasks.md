...
**File(s)**: `specs/138-refactor-skill-md-progressive-disclosure/feature.gherkin`
**Type**: Create
**Depends**: None
**Acceptance**:
...
**File(s)**: `scripts/__fixtures__/skill-exercise/rubrics/draft-issue.md`, `specs/138-refactor-skill-md-progressive-disclosure/feature.gherkin`
**Type**: Modify
