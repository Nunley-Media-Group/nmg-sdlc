...
| `specs/159-fix-canonical-umbrella-classification-for-verified-specs/*` | Record approved requirements, design, tasks, and six regression scenarios. | Keeps implementation traceable to issue #159. |
