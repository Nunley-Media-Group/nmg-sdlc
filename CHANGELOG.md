...
- Accept canonical named-scenario evidence from implicit issue scopes and route safe local report-evidence errors into bounded verification repair instead of unnecessary intervention (#369).
