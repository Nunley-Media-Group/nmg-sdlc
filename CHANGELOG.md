...
- Deliver fresh generated worker prompts exactly once through `herdr agent prompt` after proven-live readiness, and wait through initial stale idle before settlement (#347).
